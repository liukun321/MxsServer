package com.mxs.mxsserver.protocol.pack;
...
import com.mxs.mxsserver.protocol.PacketHeaderConvertException;
import com.mxs.mxsserver.protocol.encrypt.RC4;
...
public class PackagePacker {
	 ...
	 * @return
	 */
	public Pack packRequest(Responce responce) {
		
		LinkFrame linkFrame = responce.getLinkFrame();
		
		Pack body = responce.packResponce();
