...
public class MobilePay implements Serializable{
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((coffeeList == null) ? 0 : coffeeList.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (coffeeList == null) {
			if (other.coffeeList != null)
				return false;
		} else if (!coffeeList.equals(other.coffeeList))
			return false;
		if (credit == null) {
	...
	public String toString() {
		return "MobilePay [indentId=" + indentId + ", machineId=" + machineId + ", openId=" + openId + ", credit="
				...
				+ ", totalCup=" + totalCup + ", over=" + over + ", coffeeList=" + coffeeList + "]";
	}
